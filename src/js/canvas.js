...
function init() {
  ...
  blockTriImage =  createImage(blockTri)
  blockImage =  createImage(block)
  lgPlatformImage =  createImage(lgPlatform)
  tPlatformImage =  createImage(tPlatform)
  xtPlatformImage =  createImage(xtPlatform)
  flagPoleImage =  createImage(flagPoleSprite)
...
function initLevel2() {
  ...
  blockTriImage =  createImage(blockTri)
  blockImage =  createImage(block)
  lgPlatformImage =  createImage(images.levels[2].lgPlatform)
  tPlatformImage =  createImage(tPlatform)
  xtPlatformImage =  createImage(xtPlatform)
  flagPoleImage =  createImage(flagPoleSprite)
  const mountains =  createImage(images.levels[2].mountains)
  const mdPlatformImage =  createImage(images.levels[2].mdPlatform)
